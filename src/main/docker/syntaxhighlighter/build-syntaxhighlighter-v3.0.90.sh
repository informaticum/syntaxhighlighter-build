...
# In order to build "SyntaxHighlighter v3.0.90" [1], you need an old "Node.js".
# Otherwise, when running "grunt" an error is thrown:
#     Error: Module did not self-register
#
# Instead of fixing this situation by installing the old "Node.js" [2], I prefer
# the containered way [3]:
